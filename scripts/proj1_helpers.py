...
def load_headers(data_path):
    data = np.genfromtxt(data_path, delimiter=",",  dtype=str, names = True);
    return data.dtype.names[2:]
...
def predict_labels(weights, data, model = 'ridge_regression'):
